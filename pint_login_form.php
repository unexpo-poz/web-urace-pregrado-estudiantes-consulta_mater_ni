...
?>		  </p>
		...
		<div style="font-family:arial; font-size:26px; color:red;text-align:center; font-weight:bold;">
			ATENCION: Para poder consultar su planilla<br>debe primero formalizar su inscripcion.
		</div>
...
<table style="border-collapse:collapse;padding-left:350px;" border="0" cellpadding="0" cellspacing="1" width="85%" ><tr><td>
			<br><table style="padding-left:280px;"class="normal">
				...
				<tr>
					...
					<td>
						<input name="contra_v" size="35" tabindex="2" type="text">
					</td>
				<tr>
			</table>
<br>
...
?>
	...
	<td class ="instruc" width="15%">&nbsp;</td>
      ...
      <ul style="padding-right:25px;text-align:justify;">
        <li>Para ingresar al sistema complete los datos solicitados en el formulario.</li>
		<li>Para poder consultar su planilla debe formalizar su inscripcion en la Unidad Regional de Control de Estudios (URACE).</li>
